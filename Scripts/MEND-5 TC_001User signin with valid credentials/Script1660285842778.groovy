...
WebUI.setText(findTestObject('Object Repository/MendixSignIn/Page_Login/input_User name_usernameInput'), Username)

WebUI.setEncryptedText(findTestObject('Object Repository/MendixSignIn/Page_Login/input_Password_passwordInput'), Password)
